  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#020408] text-white selection:bg-blue-500 selection:text-white font-sans overflow-x-hidden">
      ...
      <nav className="fixed top-0 z-[100] w-full border-b border-white/5 bg-[#020408]/60 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 text-left">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20">
          ...
          <div className="max-w-6xl mx-auto relative z-10 text-center">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-black tracking-[-0.05em] text-white leading-[0.85] uppercase italic mb-12 text-balance">
                Commit <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20">Money where your mouth is.</span>
              </h1>
              
              <p className="mx-auto max-w-2xl text-lg md:text-xl text-white/40 leading-relaxed font-medium italic mb-16">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-24">
                <Link to="/login" className="group relative px-10 py-6 rounded-3xl bg-blue-600 text-white font-black text-xs uppercase tracking-[0.3em] shadow-2xl hover:scale-105 active:scale-95 transition-all overflow-hidden">
                    ...
                    <span className="relative flex items-center gap-3 font-black tracking-widest">Initiate Protocol <ArrowRight size={16} /></span>
                </Link>
                <a href="#protocol" className="px-10 py-6 rounded-3xl border border-white/10 bg-white/5 text-white font-black text-xs uppercase tracking-[0.3em] hover:bg-white/10 transition-all font-black tracking-widest">
                    System Architecture
                </a>
              </div>
            </motion.div>
                ...
                <div className="p-12 grid grid-cols-12 gap-10">
                    <div className="col-span-7 space-y-10">
                        ...
                        <div className="grid grid-cols-2 gap-6 font-black italic">
                            <div className="p-6 rounded-[2rem] bg-white/[0.03] border border-white/5 shadow-inner">
                                <p className="text-[9px] font-black uppercase tracking-widest text-white/20 mb-2 font-black">Vault Balance</p>
                                <p className="text-2xl font-black italic">₦450,000</p>
                            </div>
                            <div className="p-6 rounded-[2rem] bg-white/[0.03] border border-white/5 shadow-inner">
                                <p className="text-[9px] font-black uppercase tracking-widest text-white/20 mb-2 font-black">Integrity Score</p>
                    ...
                    <div className="col-span-5 flex flex-col justify-center text-left">
                        <div className="p-8 rounded-[2.5rem] bg-blue-600/5 border border-blue-500/20 relative overflow-hidden">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-blue-400 mb-6 font-black tracking-widest">Current Streak</p>
                            <p className="text-3xl font-black italic mb-2">14 DAYS</p>
                            <p className="text-[10px] text-white/40 font-bold uppercase italic tracking-tighter font-black">Consistency Level: Elite</p>
                        </div>
                    </div>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-left">
                    ...
                    <div className="lg:col-span-4 relative overflow-hidden rounded-[3.5rem] border border-white/5 bg-white/[0.02] p-12 flex flex-col justify-between group">
                        ...
                        <div>
                            <h2 className="text-3xl font-black italic uppercase tracking-tighter mb-6">Mandate Precision.</h2>
                        ...
                        <div className="mt-10 flex gap-2 overflow-hidden opacity-20 group-hover:opacity-100 transition-opacity">
                            {['Habit', 'Finance', 'Code'].map(t => (
                                <span key={t} className="px-4 py-2 rounded-full border border-white/10 text-[9px] font-black uppercase tracking-widest font-black tracking-widest">{t}</span>
                            ))}
                        </div>
                    </div>
                    
                    <div className="lg:col-span-4 relative overflow-hidden rounded-[3.5rem] border border-white/5 bg-white/[0.02] p-12 group">
                        <div className="h-14 w-14 rounded-2xl bg-white/5 flex items-center justify-center text-white/40 mb-10 border border-white/10 shadow-xl">
                            <Layers size={28} />
                        </div>
                        <h2 className="text-3xl font-black italic uppercase tracking-tighter mb-6">System Logs.</h2>
                        <p className="text-white/40 font-medium italic uppercase text-sm leading-relaxed font-black">
                    ...
                    <div className="lg:col-span-8 relative overflow-hidden rounded-[3.5rem] border border-white/5 bg-white/[0.02] p-12 flex items-center gap-10 group">
                        <div className="flex-1">
                            ...
                            <h2 className="text-4xl font-black italic uppercase tracking-tighter mb-6">Execution Metrics.</h2>
                            <p className="text-xl text-white/40 leading-relaxed font-medium italic uppercase tracking-tight max-w-md font-black">
                                Progress is the only metric that matters. Watch your identity transform as you rack up successful mandates.
                            </p>
                        </div>
                        <div className="hidden md:block w-64 space-y-4">
                            <div className="p-5 rounded-2xl bg-green-500/10 border border-green-500/20 text-[10px] font-black uppercase text-green-500 italic font-black tracking-widest">Protocol Success: 100%</div>
                            <div className="p-5 rounded-2xl bg-blue-500/10 border border-blue-500/20 text-[10px] font-black uppercase text-blue-500 italic font-black tracking-widest">Integrity Boost: +1.2%</div>
                        </div>
                    </div>
                </div>
            </div>
